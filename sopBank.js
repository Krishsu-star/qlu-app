...
router.post("/upload", requireAuth, requireRole("Admin", "HR", "QA"), upload.single("file"), async (req, res) => {
...
router.delete("/:id", requireAuth, requireRole("Admin", "HR", "QA"), async (req, res) => {
